...
class Command(BaseCommand):
            ...
            try:
                ...
                for match in print_matches:
                    ...
                    self.add_issue(
                        'low',
                        'Code Hygiene',
                        "Found print() statement (use logging instead)",
    ...
    def generate_summary(self):
        ...
        self.report.append("**Project**: Kibray Construction Management System\n")
        self.report.append("**Branch**: chore/security/upgrade-django-requests\n\n")
