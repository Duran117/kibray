...
class Command(BaseCommand):
    help = (
        "Importa BudgetProgress desde CSV. Encabezados: project_id,cost_code,date,percent_complete,qty_completed,note"
    )
    ...
    def handle(self, *args, **opts):
        ...
        try:
            with open_csv_source(path) as f:
                ...
                self.stdout.write(
                    self.style.SUCCESS(f"Listo. created={created}, updated={updated}, skipped={skipped}, dry_run={dry}")
                )
