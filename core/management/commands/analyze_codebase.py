...
class CodeAnalyzer:
    ...
    DJANGO_STANDARD_METHODS = {
        ...
        # Model methods
        'save', 'delete', 'clean', '__str__', '__repr__', '__init__',
        ...
        # Admin methods
        'save_model', 'delete_model', 'save_formset', 'get_queryset',
        # Management command
        'handle', 'add_arguments',
        # Test methods
        'setUp', 'tearDown', 'setUpClass', 'tearDownClass',
        'setUpTestData', 'test_', 'setUp', 'tearDown',
        # Signal handlers
...
class Command(BaseCommand):
    ...
    def generate_report(self, analyzer, base_dir):
        ...
        with open(report_path, 'w', encoding='utf-8') as f:
            ...
            f.write(f"**Analyzer:** Code Quality Specialist v1.0\n\n")
            f.write("---\n\n")
