...
class IsProjectMember(BasePermission):
    ...
    def has_object_permission(self, request, view, obj):
        ...
        if hasattr(obj, 'project_lead') and obj.project_lead:
            if hasattr(obj.project_lead, 'user') and obj.project_lead.user == request.user:
                return True
...
class IsProjectLeadOrReadOnly(BasePermission):
    ...
    def has_object_permission(self, request, view, obj):
        ...
        if hasattr(obj, 'project_lead') and obj.project_lead:
            if hasattr(obj.project_lead, 'user'):
...
class IsBillingOrganizationMember(BasePermission):
    ...
    def has_object_permission(self, request, view, obj):
        ...
        if hasattr(request.user, 'profile') and hasattr(request.user.profile, 'client_contact'):
            client_contact = request.user.profile.client_contact
            if hasattr(obj, 'billing_organization') and obj.billing_organization:
                return client_contact.organization == obj.billing_organization
    ...
    def has_object_permission(self, request, view, obj):
        ...
        if request.method in SAFE_METHODS:
            if hasattr(request.user, 'profile') and hasattr(request.user.profile, 'client_contact'):
                client_contact = request.user.profile.client_contact
                if hasattr(obj, 'billing_organization') and obj.billing_organization:
                    if client_contact.organization == obj.billing_organization:
                        return True
