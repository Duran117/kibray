...
class ProjectCreateUpdateSerializer(serializers.ModelSerializer):
    ...
    billing_organization = serializers.PrimaryKeyRelatedField(
        queryset=ClientOrganization.objects.all(), required=False, allow_null=True
    )
    project_lead = serializers.PrimaryKeyRelatedField(
        queryset=ClientContact.objects.all(), required=False, allow_null=True
    )
    observers = serializers.PrimaryKeyRelatedField(
        queryset=ClientContact.objects.all(), many=True, required=False
    )
