...
def diagnose_employee_clock_in(username):
    ...
    if assignments_today.exists():
        ...
        print(f"   ⚠️  NO hay asignaciones específicas para hoy")
    ...
    if projects_from_assignments.exists():
        ...
        print(f"   ⚠️  NO hay proyectos desde asignaciones de hoy")
    ...
    if projects_from_recent_work.exists():
        ...
        print(f"   ⚠️  NO hay proyectos con trabajo reciente")
