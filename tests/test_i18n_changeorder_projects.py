...
from core.models import ChangeOrder, Employee, Project
...
class TestChangeOrderBoardI18n:
    ...
    def test_changeorder_status_labels_spanish(self):
        ...
        co = ChangeOrder.objects.create(
            project=project, reference_code="CO-001", description="Test CO", status="pending", amount=Decimal("100.00")
        )
    ...
    def test_changeorder_status_labels_english(self):
        ...
        project = Project.objects.create(name="Test Project 2", start_date=date.today())
...
class TestProjectListI18n:
    ...
    def test_project_list_empty_state_spanish(self):
        ...
        assert "No hay proyectos" in content or "Sin proyectos" in content or "proyectos disponibles" in content
    ...
    def test_project_list_empty_state_english(self):
        ...
        # Verificar mensaje de estado vacío en inglés
        assert "No projects" in content or "no projects available" in content.lower()
    ...
    def test_project_list_with_data_labels(self):
        ...
        Project.objects.create(
            name="Test Project", client="Test Client", start_date=date.today(), description="Test description"
        )
