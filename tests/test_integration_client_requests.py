...
from core.models import ClientProjectAccess, ClientRequest, Project
...
def test_client_request_access_isolation(api_client, client_user, staff_user, project):
    ...
    res1 = api_client.post(
        ...
        {"project": project.id, "request_type": "info", "title": "Staff request", "description": "Internal query"},
        format="json",
    )
...
def test_client_request_status_transitions(api_client, staff_user, project):
    ...
    res2 = api_client.post(
        "/api/v1/client-requests/",
        {"project": project.id, "request_type": "material", "title": "Wrong material", "description": "Not feasible"},
        format="json",
    )
    rid2 = res2.data["id"]
