...
def test_client_visibility_restricted_to_access(api_client, client_user, project_a, project_b):
    ...
    res_a = api_client.post(
        ...
        {"project": project_a.id, "title": "Info A", "description": "A", "request_type": "info"},
        format="json",
    )
    ...
    res_b = api_client.post(
        "/api/v1/client-requests/",
        {"project": project_b.id, "title": "Info B", "description": "B", "request_type": "info"},
        format="json",
    )
...
def test_staff_sees_all(api_client, staff, project_a, project_b):
    ...
    res_a = api_client.post(
        "/api/v1/client-requests/",
        {"project": project_a.id, "title": "Staff A", "description": "A", "request_type": "info"},
        format="json",
    )
    res_b = api_client.post(
        "/api/v1/client-requests/",
        {"project": project_b.id, "title": "Staff B", "description": "B", "request_type": "info"},
        format="json",
    )
