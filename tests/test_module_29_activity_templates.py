...
class TestActivityTemplateSearch:
    ...
    def test_search_by_tips(self):
        ...
        ActivityTemplate.objects.create(
            name="Staining",
            category="STAIN",
            tips="Always use grain filler first",
            created_by=user
        )
...
class TestActivityTemplateVersioning:
    ...
    def test_create_new_version(self):
        ...
        new_version = original.create_new_version(
            updated_by=editor,
            version_notes="Updated steps and materials"
        )
    ...
    def test_multiple_versions(self):
        ...
        v1 = ActivityTemplate.objects.create(
            name="Test",
            category="PREP",
            created_by=user
        )
...
class TestActivityTemplateFactories:
    ...
    def test_create_paint_template(self):
        ...
        template = ActivityTemplate.create_paint_template(
            name="Interior Paint",
            creator=user
        )
    ...
    def test_create_cleanup_template(self):
        ...
        template = ActivityTemplate.create_cleanup_template(
            name="Site Cleanup",
            creator=user
        )
