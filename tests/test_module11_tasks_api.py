...
from core.models import Project, Task, Employee, TaskStatusChange, TimeEntry
...
class TestModule11TaskAPI:
    def setup_method(self):
        ...
        self.employee = Employee.objects.create(user=self.employee_user, first_name='Emp', last_name='User', social_security_number='123', hourly_rate=25)
    ...
    def test_hours_summary(self):
        ...
        TimeEntry.objects.create(employee=self.employee, project=self.project, task=task, date=date.today(), start_time=time(8,0), end_time=time(10,0))
