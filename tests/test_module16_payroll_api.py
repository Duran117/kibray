...
class TestPayrollAPI:
    def test_period_approve_and_record_payment(self, api_client, user, employee, week_bounds):
        ...
        # Create period
        p_res = api_client.post('/api/v1/payroll/periods/', {
        ...
        # Create record
        r_res = api_client.post('/api/v1/payroll/records/', {
            'period': period_id,
        ...
        adj = api_client.post(f'/api/v1/payroll/records/{rec_id}/manual_adjust/', {
            'reason': 'set totals',
            'updates': {
                'gross_pay': '1310.00',
                'net_pay': '1300.00',
        ...
        a_res = api_client.post(f'/api/v1/payroll/periods/{period_id}/approve/', {'skip_validation': True}, format='json')
        assert a_res.status_code == 200
        # Create partial payment
        pay_res = api_client.post('/api/v1/payroll/payments/', {
