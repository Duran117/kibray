...
def count_api_endpoints():
    ...
    with open(api_views_file, 'r', encoding='utf-8') as f:
        content = f.read()
...
def audit_comprehensive():
    ...
    print(f"Templates implementados: {templates_count:3d} de ~{int(expected_templates):3d} esperados ({templates_percentage:.1f}%)")
