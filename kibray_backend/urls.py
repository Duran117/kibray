...
urlpatterns = [
    ...
    path(
        "users/manage/<int:user_id>/edit/",
        views_user_wizard.user_wizard_view,
        name="user_wizard_edit",
    ),
    ...
    path(
        "pm-calendar/new/", views_calendar_wizard.calendar_wizard_view, name="calendar_wizard_new"
    ),
    path(
        "pm-calendar/save/", views_calendar_wizard.calendar_wizard_save, name="calendar_wizard_save"
    ),
    path("pm-calendar/block/", pm_calendar_views.pm_block_day, name="pm_block_day"),
    path(
        "pm-calendar/unblock/<int:blocked_day_id>/",
        pm_calendar_views.pm_unblock_day,
        name="pm_unblock_day",
    ),
    path(
        "pm-calendar/api/data/", pm_calendar_views.pm_calendar_api_data, name="pm_calendar_api_data"
    ),
    path("focus/", views.focus_wizard, name="focus_wizard"),
    path("planner/", planner_views.quick_planner_entry, name="quick_planner"),
    path(
        "planner/strategic/",
        views.StrategicPlanningDashboardView.as_view(),
        name="strategic_planning_dashboard",
    ),
    path(
        "planner/strategic/<int:pk>/",
        views.StrategicPlanningDetailView.as_view(),
        name="strategic_planning_detail",
    ),
    ...
    path(
        ...
        views_assignments.assignment_delete,
    ...
    path(
        "projects/launchpad/", views_wizards.project_launchpad_wizard, name="project_launchpad"
    ),  # NEW: Wizard
    path(
        "projects/launchpad/ai-suggest/",
        views_wizards.project_launchpad_ai_suggest,
        name="project_launchpad_ai",
    ),
    path(
        "projects/launchpad/save/",
        views_wizards.project_launchpad_save,
        name="project_launchpad_save",
    ),
    path("projects/create/", views.project_create, name="project_create"),
    path("projects/<int:project_id>/edit/", views.project_edit, name="project_edit"),
    path("projects/<int:project_id>/delete/", views.project_delete, name="project_delete"),
    path(
        "projects/<int:project_id>/toggle-status/",
        views.project_status_toggle,
        name="project_status_toggle",
    ),
    ...
    path(
        "projects/<int:project_id>/materials/request/",
        views.materials_request_view,
    ...
    path(
        "projects/<int:project_id>/schedule/", views.project_schedule_view, name="project_schedule"
    ),
    # Schedule Generator (Hierarchical)
    path(
        "projects/<int:project_id>/schedule/generator/",
        views.schedule_generator_view,
        name="schedule_generator",
    ),
    path(
        "schedule/category/<int:category_id>/edit/",
        views.schedule_category_edit,
        name="schedule_category_edit",
    ),
    path(
        "schedule/category/<int:category_id>/delete/",
        views.schedule_category_delete,
        name="schedule_category_delete",
    ),
    path("schedule/item/<int:item_id>/edit/", views.schedule_item_edit, name="schedule_item_edit"),
    path(
        "schedule/item/<int:item_id>/delete/",
        views.schedule_item_delete,
        name="schedule_item_delete",
    ),
    # Calendar Integration
    path(
        "projects/<int:project_id>/schedule/export.ics",
        views.project_schedule_ics,
        name="project_schedule_ics",
    ),
    path(
    ...
    # React Gantt Chart
    path(
        "projects/<int:project_id>/schedule/gantt/",
        views.schedule_gantt_react_view,
        name="schedule_gantt_react",
    ),
    # Client Calendar - NEW
    path(
        "projects/<int:project_id>/calendar/client/",
        client_calendar_views.client_project_calendar_view,
        name="client_project_calendar",
    ),
    path(
        "projects/<int:project_id>/calendar/client/api/",
        client_calendar_views.client_calendar_api_data,
        name="client_calendar_api_data",
    ),
    path(
        "schedule/item/<int:item_id>/detail/",
    ...
    path(
        "projects/<int:project_id>/colors/new/",
    ...
    path(
        "colors/sample/<int:sample_id>/delete/",
        views.color_sample_delete,
        name="color_sample_delete",
    ),
    path(
        "colors/sample/<int:sample_id>/review/",
        views.color_sample_review,
        name="color_sample_review",
    ),
    path(
        "colors/sample/<int:sample_id>/quick-action/",
    ...
    path(
        ...
        views.touchup_board_react,
        name="touchup_board_react",
    ),
    path(
        "touchups/quick-update/<int:task_id>/",
    ...
    path(
        "projects/<int:project_id>/color-approvals/",
        views.color_approvals_react,
        name="color_approvals_react_project",
    ),
    ...
    path(
        "damages/<int:report_id>/delete/", views.damage_report_delete, name="damage_report_delete"
    ),
    path(
        "damages/<int:report_id>/add-photos/",
        views.damage_report_add_photos,
        name="damage_report_add_photos",
    ),
    path(
        "damages/<int:report_id>/update-status/",
    ...
    # Change Orders
    path(
        "changeorder/<int:changeorder_id>/",
        views.changeorder_detail_view,
        name="changeorder_detail",
    ),
    path(
        "changeorder/<int:changeorder_id>/billing-history/",
        views.changeorder_billing_history_view,
    ...
    path(
        "changeorder/<int:changeorder_id>/sign/<str:token>/",
        views.changeorder_customer_signature_view,
    ...
    path(
        ...
        name="photo_editor_standalone",
    ),
    # Color Sample Signatures
    path(
        "colors/sample/<int:sample_id>/sign/",
        views.color_sample_client_signature_view,
        name="color_sample_client_signature",
    ),
    path(
        "colors/sample/<int:sample_id>/sign/<str:token>/",
        views.color_sample_client_signature_view,
    ...
    path(
        ...
        views.client_request_create,
        name="client_request_create",
    ),
    path(
        "projects/<int:project_id>/client-requests/",
        views.client_requests_list,
        name="client_requests_list",
    ),
    path("client-requests/", views.client_requests_list, name="client_requests_list_all"),
    path(
        "client-requests/<int:request_id>/convert/",
        views.client_request_convert_to_co,
        name="client_request_convert",
    ),
    # Payroll
    ...
    path(
        "payroll/record/<int:record_id>/pay/",
    ...
    path(
        "api/changeorders/<int:co_id>/update-status/",
        views.changeorder_update_status,
        name="changeorder_update_status",
    ),
    path(
    ...
    path(
        "api/projects/<int:project_id>/approved-colors/",
    ...
    # Estimates
    path(
        "projects/<int:project_id>/estimates/new/",
        views.estimate_create_view,
    ...
    path(
        "projects/<int:project_id>/daily-log/create/",
        views.daily_log_create,
    ...
    path(
        "projects/<int:project_id>/files/category/create/",
        views.file_category_create,
        name="file_category_create",
    ),
    path(
        "projects/<int:project_id>/files/<int:category_id>/upload/",
        views.file_upload,
        name="file_upload",
    ),
    ...
    *(
        [
            path(
                "projects/<int:project_id>/touchup-plans/",
                views.touchup_plans_list,
                name="touchup_plans_list",
            ),
            path(
                "plans/<int:plan_id>/touchups/",
                views.touchup_plan_detail,
                name="touchup_plan_detail",
            ),
            path(
                "plans/<int:plan_id>/touchups/create/", views.touchup_create, name="touchup_create"
            ),
            path(
                "touchups/<int:touchup_id>/", views.touchup_detail_ajax, name="touchup_detail_ajax"
            ),
            path("touchups/<int:touchup_id>/update/", views.touchup_update, name="touchup_update"),
            path(
                "touchups/<int:touchup_id>/complete/",
                views.touchup_complete,
                name="touchup_complete",
            ),
            path("touchups/<int:touchup_id>/delete/", views.touchup_delete, name="touchup_delete"),
            path(
                "touchups/<int:touchup_id>/approve/", views.touchup_approve, name="touchup_approve"
            ),
    ...
    path(
        "pins/attachments/<int:attachment_id>/delete/",
        views.pin_delete_photo,
        name="pin_delete_photo",
    ),
    # Earned Value + export
    path("projects/<int:project_id>/earned-value/", views.project_ev_view, name="project_ev"),
    path(
        "projects/<int:project_id>/earned-value/series/",
        views.project_ev_series,
        name="project_ev_series",
    ),
    path(
        "projects/<int:project_id>/earned-value/csv/", views.project_ev_csv, name="project_ev_csv"
    ),
    path(
        "projects/<int:project_id>/progress/upload/",
        views.upload_project_progress,
        name="upload_project_progress",
    ),
    path(
        "projects/<int:project_id>/progress/sample.csv",
        views.download_progress_sample,
        name="download_progress_sample",
    ),
    path(
        "projects/<int:project_id>/progress/export.csv",
        views.project_progress_csv,
        name="project_progress_csv",
    ),
    path(
        "projects/<int:project_id>/progress/<int:pk>/delete/",
        views.delete_progress,
        name="delete_progress",
    ),
    path(
        "projects/<int:project_id>/progress/<int:pk>/edit/",
        views.edit_progress,
        name="edit_progress",
    ),
    path(
    ...
    # Inventario
    path(
        "projects/<int:project_id>/inventory/wizard/",
    ...
    path(
        ...
        name="materials_requests_list_all",
    ),
    path(
    ...
    path(
        "materials/requests/<int:request_id>/",
        views.materials_request_detail_view,
        name="materials_request_detail",
    ),
    path(
    ...
    path(
        ...
        views.materials_request_submit,
        name="materials_request_submit",
    ),
    path(
    ...
    path(
        "materials/requests/<int:request_id>/reject/",
        views.materials_request_reject,
        name="materials_request_reject",
    ),
    path(
    ...
    path(
        "inventory/adjust/<int:item_id>/<int:location_id>/",
    ...
    path(
        "planning/project/<int:project_id>/create/",
        views.daily_plan_create,
    ...
    path(
        "planning/activity/<int:activity_id>/complete/",
    ...
    path(
        "planning/sop/express/", views_sop.sop_express_creator, name="sop_express"
    ),  # NEW: Express AI version
    path("planning/sop/create/", views.sop_create_wizard, name="sop_create"),  # Wizard version
    path(
        "planning/sop/create/classic/", views.sop_create_edit, name="sop_create_classic"
    ),  # OLD: Classic form
    path(
        "planning/sop/<int:template_id>/edit/", views.sop_create_wizard, name="sop_edit"
    ),  # NEW: Wizard for editing
    path(
        "planning/sop/<int:template_id>/edit/classic/",
        views.sop_create_edit,
        name="sop_edit_classic",
    ),  # OLD
    # Minutas / Project Timeline
    path(
        "projects/<int:project_id>/minutes/",
        views.project_minutes_list,
        name="project_minutes_list",
    ),
    path(
        "projects/<int:project_id>/minutes/new/",
        views.project_minute_create,
    ...
    path(
        ...
        notif_views.notifications_mark_all_read,
    ...
    path(
        ...
        name="employee_performance_list",
    ),
    path(
    ...
    path("tasks/create/", views.task_create_wizard, name="task_create_wizard"),
    ...
    path(
        "planning/<int:plan_id>/fetch-weather/",
        views.daily_plan_fetch_weather,
        name="daily_plan_fetch_weather",
    ),
    path(
    ...
    path(
        "planning/<int:plan_id>/productivity/",
        views.daily_plan_productivity,
        name="daily_plan_productivity",
    ),
    # ===== GESTIÓN DE CLIENTES =====
    ...
    path(
        "clients/<int:user_id>/reset-password/",
        views.client_reset_password,
        name="client_reset_password",
    ),
    path(
        "clients/<int:user_id>/assign-project/",
    ...
    path(
        "api/v1/planner/habits/active/",
        planner_views.get_active_habits,
        name="planner-active-habits",
    ),
    path(
        "api/v1/planner/visions/random/",
        planner_views.get_random_vision,
        name="planner-random-vision",
    ),
    path(
        "api/v1/planner/ritual/complete/",
        planner_views.complete_ritual,
        name="planner-complete-ritual",
    ),
    path(
        "api/v1/planner/ritual/today/",
        planner_views.today_ritual_summary,
        name="planner-today-ritual",
    ),
    path(
        "api/v1/planner/action/<int:action_id>/toggle/",
        planner_views.toggle_power_action_status,
        name="planner-toggle-action",
    ),
    path(
        "api/v1/planner/action/<int:action_id>/step/<int:step_index>/",
        planner_views.update_micro_step,
        name="planner-update-step",
    ),
    path("api/v1/planner/stats/", planner_views.planner_stats, name="planner-stats"),
    path(
        "api/v1/planner/feed/<str:user_token>.ics",
        planner_views.planner_calendar_feed,
        name="planner-calendar-feed",
    ),
    # AI-Assisted Planning Endpoints
    path(
        "api/v1/planner/ai/process-dump/",
        planner_views.ai_process_brain_dump,
        name="planner-ai-process-dump",
    ),
    path(
        "api/v1/planner/ai/suggest-frog/",
        planner_views.ai_suggest_frog,
        name="planner-ai-suggest-frog",
    ),
    path(
        "api/v1/planner/ai/generate-steps/",
        planner_views.ai_generate_micro_steps,
        name="planner-ai-generate-steps",
    ),
    path(
        "api/v1/planner/ai/suggest-time/",
        planner_views.ai_suggest_time_blocks,
        name="planner-ai-suggest-time",
    ),
