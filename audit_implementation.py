...
CRITICAL_MODELS = [
    'Project', 'Client', 'Employee', 'TimeEntry', 'Expense', 'Income',
    'Invoice', 'Estimate', 'ChangeOrder', 'Schedule', 'Task', 'DailyPlan',
    'SOP', 'Minute', 'RFI', 'Issue', 'Risk', 'MaterialRequest', 'ClientRequest',
    'FloorPlan', 'Photo', 'Material', 'Inventory', 'ColorSample', 'Comment',
    'Notification', 'PayrollEntry', 'DamageReport', 'TouchUp'
]

# URLs críticas que deben existir
CRITICAL_URLS = [
    'dashboard', 'project-list', 'project-create', 'project-detail',
    'expense-list', 'expense-create', 'income-list', 'income-create',
    'invoice-list', 'invoice-create', 'estimate-list', 'estimate-create',
    'changeorder-list', 'changeorder-create', 'schedule-list', 'task-list',
    'daily-plan-list', 'floor-plan-list', 'timeentry-create', 'payroll-summary'
]

# Templates críticos
CRITICAL_TEMPLATES = [
    'dashboard.html', 'project_list.html', 'project_form.html',
    'expense_list.html', 'expense_form.html', 'income_list.html', 'income_form.html',
    'invoice_list.html', 'invoice_builder.html', 'changeorder_detail.html',
    'schedule_form.html', 'task_list.html', 'daily_planning_dashboard.html',
    'floor_plan_list.html', 'timeentry_form.html', 'payroll_summary.html'
]
