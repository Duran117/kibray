...
def create_project_with_related():
    ...
    Income.objects.create(project=p, project_name='Factura 1', amount=Decimal('100.00'), date=date.today(), payment_method='EFECTIVO')
    Expense.objects.create(project=p, project_name='Compra 1', amount=Decimal('50.00'), date=date.today(), category='Material')
    return p
